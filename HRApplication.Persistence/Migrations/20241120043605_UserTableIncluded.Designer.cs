...
namespace HRApplication.Persistence.Migrations
{
    ...
    [Migration("20241120043605_UserTableIncluded")]
    partial class UserTableIncluded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRApplication.Domain.IdentityInformation.TblUserInformation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TblUserInformation", "auth");
                });
            ...
            modelBuilder.Entity("HRApplication.Domain.EmployeeManagement.TblEmployeeBasicInfo", b =>
                {
                    ...
                    b.HasOne("HRApplication.Domain.IdentityInformation.TblUserInformation", "TblUserInformation")
                        .WithOne("TblEmployeeBasicInfo")
                        .HasForeignKey("HRApplication.Domain.EmployeeManagement.TblEmployeeBasicInfo", "UserId");
                    ...
                    b.Navigation("TblUserInformation");
                });
